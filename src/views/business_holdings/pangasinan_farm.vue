...
<template>
    ...
    <v-container v-if="!isMobileView">
            ...
            <v-col cols="9" class="mx-auto">
                <div>
                    ...
                    <p style="margin-top: 3rem; font-size: 1rem;" class="text-blue-grey-darken-2">
                        Strategically located 24-hectare agricultural land in Balungao, Pangasinan, poised for
                        integrated
                        dairy, poultry, and feed production serving Northern Luzon.
                    </p>
                </div>
            </v-col>
        </v-row>
        ...
        <v-row>
            <v-col cols="9" class="mx-auto">
                <v-parallax src="/eishi/pangasinan_farm/images/dji_fly_20250311_152206_0041_1741678733665_photo.jpg"
                        ...
                        <v-col>
                            <div class="farm-table">
                                <div class="row-item">
                                    ...
                                    <div class="value">Balungao Agricultural Land</div>
                                </div>

                                <div class="row-item">
                                    <div class="label">Location</div>
                                    <div class="value">Balungao, Pangasinan, Philippines</div>
                                </div>

                                <div class="row-item">
                                    <div class="label">Established / Acquired</div>
                                    <div class="value">February 2025</div>
                                </div>

                                <div class="row-item">
                                    <div class="label">Municipality Classification</div>
                                    <div class="value">First-Class Municipality (January 1, 2025)</div>
                                </div>
                                ...
                                <div class="row-group">
                                    ...
                                    <div class="row-item small">
                                        <div class="label">Diversion Dam</div>
                                        <div class="value">Yes, receives water year-round from Mount Balungao</div>
                                    </div>
                                    <div class="row-item small">
                                        <div class="label">Proximity to SM Carmen</div>
                                ...
                                <div class="row-group">
                                    <div class="row-item small">
                                        <div class="label">Proximity to TPLEX Rosales Exit</div>
                                        <div class="value">6 km</div>
                                    </div>
                                    <div class="row-item small">
                                        <div class="label">Planned Facilities</div>
                                        <div class="value">Dairy farm, poultry farm, feed mill, free-range farm</div>
                                    </div>
                                    <div class="row-item small">
                                        <div class="label">Purpose</div>
                                        <div class="value">Serve Northern Luzon agricultural demands</div>
                                    </div>
                                </div>
                            </div>
                        </v-col>
...
export default {
    ...
    data() {
        return {
            ...
            images: [
                { type: 'image', src: '/eishi/pangasinan_farm/images/dji_fly_20250311_151954_0036_1741678753512_photo.jpg' },
                { type: 'image', src: '/eishi/pangasinan_farm/images/dji_fly_20250311_152206_0041_1741678733665_photo.jpg' },
                { type: 'image', src: '/eishi/pangasinan_farm/images/dji_fly_20250311_152212_0042_1741678730743_photo.jpg' },
                { type: 'image', src: '/eishi/pangasinan_farm/images/dji_fly_20250311_152328_0046_1741678719333_photo.jpg' },
                { type: 'image', src: '/eishi/pangasinan_farm/images/dji_fly_20250311_152442_0049_1741678708540_photo.jpg' },
                { type: 'image', src: '/eishi/pangasinan_farm/images/dji_fly_20250311_160640_0074_1741681516533_photo.jpg' },
                { type: 'image', src: '/eishi/pangasinan_farm/images/dji_fly_20250311_161732_0095_1741681475707_photo.jpg' },
                { type: 'image', src: '/eishi/pangasinan_farm/images/dji_fly_20250311_161920_0098_1741681467332_photo.jpg' },
                { type: 'image', src: '/eishi/pangasinan_farm/images/dji_fly_20250311_161950_0099_1741681464833_photo.jpg' },
                { type: 'image', src: '/eishi/pangasinan_farm/images/dji_fly_20250311_162100_0102_1741681456944_photo.jpg' },
            ],
