...
<template>
    ...
    <v-container v-if="!isMobileView">
            ...
            <v-col cols="9" class="mx-auto">
                <div>
                    ...
                    <p style="margin-top: 3rem; font-size: 1rem;" class="text-blue-grey-darken-2">
                        Strategically acquired residential lots in Tabuk City, Kalinga, positioned for long-term growth
                        and
        ...
        <v-row>
            <v-col cols="9" class="mx-auto">
                <v-parallax src="/eishi/kalinga_residential/images/DJI_0595-min.jpg" height="calc(100vh - 200px)">
                </v-parallax>
            </v-col>
        </v-row>
                        ...
                        <v-col>
                            <div class="farm-table">
                                <div class="row-item">
                                    ...
                                    <div class="value">Residential Lots in Tabuk City</div>
                                </div>

                                <div class="row-item">
                                    <div class="label">Location</div>
                                    <div class="value">Near Kalinga Capitol, Tabuk City, Kalinga</div>
                                </div>

                                <div class="row-item">
                                    <div class="label">Acquisition Date</div>
                                    <div class="value">November 2024</div>
                                </div>

                                <div class="row-item">
                                    <div class="label">Purpose</div>
                                    <div class="value">Planned offering to National Housing Authority for government
                                        housing
                                        projects</div>
                                </div>
                                ...
                                <div class="row-group">
                                    <div class="row-item small">
                                        <div class="label">Number of Lots</div>
                                        <div class="value">42 lots</div>
                                    </div>

                                    <div class="row-item small">
                                        <div class="label">Expected Growth</div>
                                        <div class="value">Price expected to increase over the years</div>
                                    </div>

                                    <div class="row-item small">
                                        <div class="label">Strategic Location</div>
                                        <div class="value">Near key city landmarks and infrastructure</div>
                                    </div>
                                </div>
                            </div>
                        </v-col>
...
export default {
    ...
    data() {
        return {
            ...
            images: [
                '/eishi/kalinga_residential/images/DJI_0591-min.jpg',
                '/eishi/kalinga_residential/images/DJI_0595-min.jpg',
                '/eishi/kalinga_residential/images/DJI_0598+(1)-min.jpg',
            ],
