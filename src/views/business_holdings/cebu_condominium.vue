...
<template>
    ...
    <v-container v-if="!isMobileView">
            ...
            <v-col cols="9" class="mx-auto">
                <div>
                    ...
                    <p style="margin-top: 3rem; font-size: 1rem;" class="text-blue-grey-darken-2">
                        Premium condominiums in Cebu City’s central business district, offering strategic access to key
                        commercial, leisure, and heritage destinations.
                    </p>
                </div>
            </v-col>
        </v-row>
        ...
        <v-row>
            <v-col cols="9" class="mx-auto">
                <v-parallax src="/eishi/cebu_condo/images/20240626_094939.jpg" height="calc(100vh - 200px)">
                </v-parallax>
            </v-col>
        </v-row>
                        ...
                        <v-col>
                            <div class="farm-table">
                                <div class="row-item">
                                    ...
                                    <div class="value">Solinea Condominiums & 1016 Residences</div>
                                </div>

                                <div class="row-item">
                                    <div class="label">Location</div>
                                    <div class="value">Cebu City, Central Business District; near Metro Cebu Mall, Ayala
                                        Center, SM Cebu City</div>
                                </div>

                                <div class="row-item">
                                    <div class="label">Owned By</div>
                                    <div class="value">Eishi Company & Partners</div>
                                </div>

                                <div class="row-group">
                                    <div class="row-item small">
                                        <div class="label">Number of Condominiums</div>
                                        <div class="value">3 units</div>
                                    </div>

                                    <div class="row-item small">
                                        <div class="label">Tower</div>
                                        <div class="value">Tower 3, Lapiz, Solinea Condominiums (2 units)</div>
                                    </div>

                                    <div class="row-item small">
                                        <div class="label">Residences</div>
                                        <div class="value">1016 Residences (1 unit)</div>
                                    </div>
                                </div>

                                <div class="row-group">
                                    <div class="row-item small">
                                        <div class="label">Tourism Access</div>
                                        <div class="value">Close to islands, beaches, hotels, diving spots, heritage
                                            sites
                                        </div>
                                    </div>

                                    <div class="row-item small">
                                        <div class="label">Transport Connectivity</div>
                                        <div class="value">Air, land, and sea; gateway to central & southern Philippines
                                        </div>
                                    </div>

                                    <div class="row-item small">
                                        <div class="label">Port Access</div>
                                        <div class="value">Near Port of Cebu, 2nd largest seaport in the Philippines
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <v-col class="mx-auto">
                            <div class="video-wrapper">
                                <video autoplay loop muted playsinline>
                                    <source src="/eishi/videos/condominiums.mp4" type="video/mp4" />
                                </video>
                            </div>
                        </v-col>
                    </v-row>
...
export default {
    ...
    data() {
        return {
            ...
            images: [
                '/eishi/cebu_condo/images/20240626_094216.jpg',
                '/eishi/cebu_condo/images/20240626_094939.jpg',
                '/eishi/cebu_condo/images/20250415_141241.jpg',
                '/eishi/cebu_condo/images/20250415_141347.jpg',
                '/eishi/cebu_condo/images/20250415_141525.jpg',
                '/eishi/cebu_condo/images/20250415_142354.jpg',
                '/eishi/cebu_condo/images/20250415_143729.jpg',
                '/eishi/cebu_condo/images/20250415_143755.jpg',
                '/eishi/cebu_condo/images/20250415_143805.jpg',
                '/eishi/cebu_condo/images/20250415_142402.jpg',
                '/eishi/cebu_condo/images/20250415_142511.jpg',
                '/eishi/cebu_condo/images/20250415_143742.jpg',
                '/eishi/cebu_condo/images/20250415_141254.jpg',
                '/eishi/cebu_condo/images/20250415_141354.jpg',
                '/eishi/cebu_condo/images/20250415_142349.jpg',
                '/eishi/cebu_condo/images/20250415_142553.jpg',
                '/eishi/cebu_condo/images/20250415_143751.jpg',
            ],
